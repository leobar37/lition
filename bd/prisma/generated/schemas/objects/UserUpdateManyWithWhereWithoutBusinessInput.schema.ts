...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutBusinessInput> = z
  .object({
...
export const UserUpdateManyWithWhereWithoutBusinessInputObjectSchema = Schema;
