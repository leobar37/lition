...
const Schema: z.ZodType<Prisma.SupplierUncheckedUpdateManyWithoutBusinessNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const SupplierUncheckedUpdateManyWithoutBusinessNestedInputObjectSchema =
  Schema;
