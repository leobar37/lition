...
const Schema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => SaleUpsertWithWhereUniqueWithoutProductInputObjectSchema,
          ),
          z
            .lazy(
              () => SaleUpsertWithWhereUniqueWithoutProductInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => SaleUpdateWithWhereUniqueWithoutProductInputObjectSchema,
          ),
          z
            .lazy(
              () => SaleUpdateWithWhereUniqueWithoutProductInputObjectSchema,
...
export const SaleUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
