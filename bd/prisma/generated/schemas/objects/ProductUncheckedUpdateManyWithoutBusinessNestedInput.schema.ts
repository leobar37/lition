...
const Schema: z.ZodType<Prisma.ProductUncheckedUpdateManyWithoutBusinessNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedUpdateManyWithoutBusinessNestedInputObjectSchema =
  Schema;
