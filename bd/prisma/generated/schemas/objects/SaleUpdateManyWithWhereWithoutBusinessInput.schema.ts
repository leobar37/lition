...
const Schema: z.ZodType<Prisma.SaleUpdateManyWithWhereWithoutBusinessInput> = z
  .object({
...
export const SaleUpdateManyWithWhereWithoutBusinessInputObjectSchema = Schema;
