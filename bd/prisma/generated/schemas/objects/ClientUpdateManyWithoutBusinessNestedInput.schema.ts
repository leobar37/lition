...
const Schema: z.ZodType<Prisma.ClientUpdateManyWithoutBusinessNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => ClientUpdateManyWithWhereWithoutBusinessInputObjectSchema),
        z
          .lazy(() => ClientUpdateManyWithWhereWithoutBusinessInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const ClientUpdateManyWithoutBusinessNestedInputObjectSchema = Schema;
