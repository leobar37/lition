...
const Schema: z.ZodType<Prisma.SupplierCreateNestedManyWithoutBusinessInput> = z
  .object({
    create: z
      .union([
...
export const SupplierCreateNestedManyWithoutBusinessInputObjectSchema = Schema;
