...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateManyWithoutBusinessNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => UserUpsertWithWhereUniqueWithoutBusinessInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpsertWithWhereUniqueWithoutBusinessInputObjectSchema,
      ...
      update: z
        .union([
          z.lazy(
            () => UserUpdateWithWhereUniqueWithoutBusinessInputObjectSchema,
          ),
          z
            .lazy(
              () => UserUpdateWithWhereUniqueWithoutBusinessInputObjectSchema,
...
export const UserUncheckedUpdateManyWithoutBusinessNestedInputObjectSchema =
  Schema;
