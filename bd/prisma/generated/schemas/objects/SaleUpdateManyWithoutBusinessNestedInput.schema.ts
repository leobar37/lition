...
const Schema: z.ZodType<Prisma.SaleUpdateManyWithoutBusinessNestedInput> = z
  .object({
    create: z
      .union([
    ...
    upsert: z
      .union([
        z.lazy(() => SaleUpsertWithWhereUniqueWithoutBusinessInputObjectSchema),
        z
          .lazy(() => SaleUpsertWithWhereUniqueWithoutBusinessInputObjectSchema)
          .array(),
      ])
      .optional(),
    createMany: z
    ...
    update: z
      .union([
        z.lazy(() => SaleUpdateWithWhereUniqueWithoutBusinessInputObjectSchema),
        z
          .lazy(() => SaleUpdateWithWhereUniqueWithoutBusinessInputObjectSchema)
          .array(),
      ])
      .optional(),
    updateMany: z
...
export const SaleUpdateManyWithoutBusinessNestedInputObjectSchema = Schema;
