...
const Schema: z.ZodType<Prisma.ProductUncheckedCreateNestedManyWithoutBusinessInput> =
  z
    .object({
      create: z
        .union([
...
export const ProductUncheckedCreateNestedManyWithoutBusinessInputObjectSchema =
  Schema;
