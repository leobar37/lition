...
const Schema: z.ZodType<Prisma.UnitAliasUncheckedUpdateManyWithoutProductNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const UnitAliasUncheckedUpdateManyWithoutProductNestedInputObjectSchema =
  Schema;
