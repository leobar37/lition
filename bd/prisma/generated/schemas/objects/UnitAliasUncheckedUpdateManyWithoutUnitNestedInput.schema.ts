...
const Schema: z.ZodType<Prisma.UnitAliasUncheckedUpdateManyWithoutUnitNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      updateMany: z
        .union([
          z.lazy(
            () => UnitAliasUpdateManyWithWhereWithoutUnitInputObjectSchema,
          ),
          z
            .lazy(
              () => UnitAliasUpdateManyWithWhereWithoutUnitInputObjectSchema,
...
export const UnitAliasUncheckedUpdateManyWithoutUnitNestedInputObjectSchema =
  Schema;
