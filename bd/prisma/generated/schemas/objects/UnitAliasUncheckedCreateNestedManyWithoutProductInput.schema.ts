...
const Schema: z.ZodType<Prisma.UnitAliasUncheckedCreateNestedManyWithoutProductInput> =
  z
    .object({
      create: z
        .union([
...
export const UnitAliasUncheckedCreateNestedManyWithoutProductInputObjectSchema =
  Schema;
