...
const Schema: z.ZodType<Prisma.UnitAliasUpdateManyWithWhereWithoutUnitInput> = z
  .object({
...
export const UnitAliasUpdateManyWithWhereWithoutUnitInputObjectSchema = Schema;
